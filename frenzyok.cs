...
public class Program
{
    ...
    private static void ExecuteCode()
    {
        ...
        Thread.Sleep(500); // Pequeno delay para garantir que a tecla é pressionada
       ...
       SetCursorPos(1473, 627);  // ALTERAR AQUI
        ...
        // move para o helper
        SetCursorPos(618, 141); // ALTERAR AQUI
        Thread.Sleep(3000);
        ...
        // Thread.Sleep(24 * 60 * 1000); // Espera 30 minutos ds acabar
